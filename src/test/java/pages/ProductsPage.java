...
public class ProductsPage extends BasePage {
    ...
    @Step("🛒 Add {0} Products to the Shopping Cart")
    ...
    @Step("👉 Making Click at First Product Detail")
    ...
    @Step("🔍 Verifying Name and Price For Excel Products")
    public void verifyNameAndPriceProducts(List<ItemDetails> itemList) {
        ...
        for (ItemDetails expectedItem : itemList) {
            ...
            for (WebElement product : products) {
                ...
                if (actualName.equalsIgnoreCase(expectedName)) {
                    softAssert.assertEquals(actualPrice, expectedPrice, "❌ Price mismatch for: " + expectedName);
        ...
        if (!notFoundItems.isEmpty()) {
            ...
            softAssert.fail("❌ The Following Products Were Not Found on the Page: " + missingProducts);
        }
        softAssert.assertAll();
        Logs.info("✅ The Name and Price For Excel Products Verification Passed");
    }
